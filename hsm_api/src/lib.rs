...
/// it can accept the proposed transfer and captures in its log that it is
...
pub struct PreparedTransfer {
    ...
    /// this to ensure freshness of the transfer information.
    pub nonce: TransferNonce,
    /// An optional new log entry for the destination group.
    ...
    /// leader will require this as part of its TransferOut RPC.
...
pub struct TransferOutRequest {
    ...
    /// A Nonce and Statement generated by the destination group leader
    /// during its processing of a PrepareTransferRequest.
    pub nonce: TransferNonce,
    pub statement: PreparedTransferStatement,
