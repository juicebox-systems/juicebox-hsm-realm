...
pub enum GroupMemberRole {
    ...
    /// entries after they have been presisted to an external storage system.
    Witness,
}
...
pub enum CommitResponse {
    ...
    /// it does not have any client responses.
    NotLeader,
}
...
pub struct AppRequest {
    ...
    /// [`juicebox_api::requests::SecretsRequest::needs_forward_secrecy`].
    ///
    /// The size of the payload must not exceed
    /// [`juicebox_api::requests::BODY_SIZE_LIMIT`]; otherwise, the HSM
    /// will panic.
